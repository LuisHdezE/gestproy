...
<head>
<meta charset="utf-8"/>
<title>GestProy | Instituto de Investigaciones de la Caña de Azúcar</title>
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="aut_cnx.php" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<!--<input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Correo" name="email"/>-->
			</div>
		</div>
		<div class="form-group">
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2016 &copy; GesProy. Instituto de Investigaciones Caña Azúcar.
</div>
<!-- END COPYRIGHT -->
